...
public class PlayerAdvancedBulletScript : ProjectilesScript
{
    ...
    public void InitializePlayerAdvancedProjectile(Vector2 bulletVelocity)
    {
        //prep vector
        bulletVelocity.Normalize();
        bulletVelocity *= Constants.PLAYER_ADVANCED_BULLET_SPEED;

        //initialize the bullet info for the parent
        Initialize(bulletVelocity, Constants.PLAYER_ADVANCED_BULLET_LIFETIME);
